  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        # Runtime libraries needed by the GUI. Wayland, GL and xkbcommon are
        # dlopen'd rather than linked, so they have to stay on LD_LIBRARY_PATH
        # even once the binary itself is patched.
        ...
        # Prebuilt GUI + CLI — downloads the release binaries from GitHub.
